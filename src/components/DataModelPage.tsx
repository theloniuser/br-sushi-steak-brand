...
export function DataModelPage() {
 ...
 <p className="text-stone-500">No entities defined.</p>
 ) : (
 ...
 <p className="text-stone-500">No relationships defined.</p>
 ) : (
 ...
 <code className="font-mono text-stone-800">/data-model</code>{' '}
 or edit the file directly at{' '}
 <code className="font-mono text-stone-800">
