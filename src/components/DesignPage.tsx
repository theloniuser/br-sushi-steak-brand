...
export function DesignPage() {
 ...
 <div className="grid grid-cols-3 gap-6">
 <div>
 <p className="text-xs text-stone-500 mb-1">Heading</p>
 ...
 <div>
 <p className="text-xs text-stone-500 mb-1">Mono</p>
 ...
 {/* Edit hint */}
 <div className="bg-stone-100 rounded-md px-4 py-2.5">
 <p className="text-xs text-stone-500">
 Run <code className="font-mono text-stone-700">/design-tokens</code> to update
 </p>
 </div>
 </CardContent>
 </Card>
 ...
 <Link
 to="/shell/design"
 className="flex items-center justify-between gap-4 py-2 hover:text-stone-900:text-stone-100 transition-colors group"
 >
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 rounded-md bg-stone-200 flex items-center justify-center">
 <Layout className="w-4 h-4 text-stone-600" strokeWidth={1.5} />
 </div>
 <span className="font-medium text-stone-700 group-hover:text-stone-900:text-stone-100">
 View Shell Design
 </span>
 </div>
 ...
 <div className="bg-stone-100 rounded-md px-4 py-2.5">
 <p className="text-xs text-stone-500">
 Run <code className="font-mono text-stone-700">/design-shell</code> to update
 </p>
 </div>
 </CardContent>
 </Card>
...
function ColorSwatch({ label, colorName }: ColorSwatchProps) {
 ...
 <p className="text-xs text-stone-500">{colorName}</p>
 </div>
 )
}
