...
export function DataCard({ data }: DataCardProps) {
 ...
 strokeWidth={1.5}
 />
 <span className="text-xs text-stone-500 group-hover:text-stone-700:text-stone-300 transition-colors">
 {isJsonOpen ? 'Hide' : 'View'} JSON
 </span>
 </CollapsibleTrigger>
 <CollapsibleContent>
 <div className="bg-stone-50 rounded-md p-4 overflow-x-auto mt-3">
