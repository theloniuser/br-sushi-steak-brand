...
export function SectionPage() {
 ...
 className="flex items-center justify-between gap-4 px-6 py-4 hover:bg-stone-50:bg-stone-800/50 transition-colors"
 >
 <div className="flex items-center gap-3 min-w-0">
 <div className="w-8 h-8 rounded-md bg-stone-200 flex items-center justify-center shrink-0">
 <Layout className="w-4 h-4 text-stone-600" strokeWidth={1.5} />
 </div>
 <span className="font-medium text-stone-900 truncate">
 {screenDesign.name}
 </span>
 </div>
 <ChevronRight className="w-4 h-4 text-stone-400 shrink-0" strokeWidth={1.5} />
 </Link>
 </li>
 ))}
 </ul>
 ...
 <Card className="border-stone-200 shadow-sm border-dashed">
 <CardContent className="py-8">
 <div className="flex flex-col items-center text-center max-w-sm mx-auto">
 <div className="w-10 h-10 rounded-full bg-stone-100 flex items-center justify-center mb-3">
 <Image className="w-5 h-5 text-stone-400" strokeWidth={1.5} />
 </div>
 ...
 <div className="bg-stone-100 rounded-md px-4 py-2.5 w-full">
 ...
 <div className="aspect-video rounded-lg overflow-hidden bg-stone-100 border border-stone-200">
 <img
 src={screenshot.url}
 alt={screenshot.name}
 ...
 className="shrink-0 p-1.5 rounded-md text-stone-400 hover:text-stone-600:text-stone-300 hover:bg-stone-100:bg-stone-800 transition-colors"
 ...
 className="w-full flex items-center justify-between gap-4 px-6 py-4 bg-stone-900 text-stone-100 rounded-lg hover:bg-stone-800:bg-stone-200 transition-colors group"
 >
 ...
 className="w-full flex items-center justify-between gap-4 px-6 py-4 bg-stone-100 text-stone-700 rounded-lg hover:bg-stone-200:bg-stone-700 transition-colors group"
 >
 <div className="flex items-center gap-3">
